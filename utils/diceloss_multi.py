...
class BinaryDiceLoss(nn.Module):
    ...
    def __init__(self, smooth=1e-7, p=1):
...
class DiceLoss(nn.Module):
    ...
    def __init__(self, weight=None, ignore_index=(0, )):#np.array([1, 2, 1])
        super(DiceLoss, self).__init__()
        self.weight = weight
        self.ignore_index = ignore_index

    def forward(self, predict, target):
        target = torch.nn.functional.one_hot(target, predict.shape[1])
        ...
        return total_loss / (target.shape[1] - self.ignore_index.__len__())
# ---------------------------------------------------------------------------------------------------------
